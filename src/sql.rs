...
mod tests {
    ...
    /// Verifies projection, filtering, sorting, and limiting in a SELECT statement.
    #[test]
    ...
    /// Verifies INSERT target columns and VALUES rows are preserved.
    #[test]
    fn parses_insert_values() {
        let parsed =
            parse_statement("INSERT INTO Tasks (Name, Status) VALUES ('New task', 'To Do')")
                .unwrap();
    ...
    /// Verifies COUNT projections become the aggregate projection mode.
    #[test]
    ...
    /// Verifies unsupported COUNT shapes fail before any Notion calls are made.
    #[test]
